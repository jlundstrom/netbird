...
type WaitSSOLoginResponse struct {
	...
	LoginHint     string                 `protobuf:"bytes,2,opt,name=loginHint,proto3" json:"loginHint,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WaitSSOLoginResponse) GetLoginHint() string {
	if x != nil {
		return x.LoginHint
	}
	return ""
...
const file_daemon_proto_rawDesc = "" +
	...
	"\tloginHint\x18\x02 \x01(\tR\tloginHint\"p\n" +
	"\tUpRequest\x12%\n" +
